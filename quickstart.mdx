...
In physics, the equation for kinetic energy is $K = \frac{1}{2}mv^2$.

$\Re(z)$ and $\operatorname{Re}(z)$ is also something.

> $\Re(z)$ and $\operatorname{Re}(z)$ is in a blockquote.
